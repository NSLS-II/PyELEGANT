...
if __name__ == '__main__':
    ...
    try:
        ...
        if production:
            n_lines = 21
            mom_aper_elem_name_pattern = 'S*:S[134]'
        else:
            n_lines = 3
            #mom_aper_elem_name_pattern = 'S1A:S[13]'
            mom_aper_elem_name_pattern = 'S1A:S1'
        ...
        sys.stdout.flush()
        for fname in ['matchTemplate.ele', f'{rootname}.inp',
                      'computeLifetime', 'computeLifetime.py',
                      'evalTemplate.ele', 'processJob1.py', 'aps.lte']:
